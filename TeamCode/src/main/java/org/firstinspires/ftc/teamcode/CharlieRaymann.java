...
public class CharlieRaymann extends LinearOpMode {
    ...
    public boolean DriverMode() { return true;}
    public double DriveSpeed(){ return .5; } //% of max speed
    ...
    public boolean ArmToggle(){return false;} //will toggle Open vs Closed return
